...
#define SWIGTYPE_p_amici__ReturnData swig_types[1]
...
#define SWIGTYPE_p_std__unique_ptrT_amici__Model_t swig_types[8]
...
/*-----------------------------------------------
              @(target):= _model_steadystate_scaled.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__model_steadystate_scaled

#else
#  define SWIG_init    init_model_steadystate_scaled

#endif
#define SWIG_name    "_model_steadystate_scaled"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_getModel(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::unique_ptr< amici::Model > result;
  
  if(!PyArg_UnpackTuple(args,(char *)"getModel",0,0)) SWIG_fail;
  {
    try {
      result = getModel();
  ...
  resultobj = SWIG_NewPointerObj(new std::unique_ptr< amici::Model >(std::move(result)), SWIGTYPE_p_std__unique_ptrT_amici__Model_t, SWIG_POINTER_OWN);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"getModel", _wrap_getModel, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_amici__ReturnData = {"_p_amici__ReturnData", "amici::ReturnData *", 0, 0, (void*)0, 0};
