 ...
 * @return
 */
extern void J_model_steadystate_scaled(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_model_steadystate_scaled(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_model_steadystate_scaled(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_model_steadystate_scaled(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_model_steadystate_scaled(sunindextype *colptrs);
extern void JSparse_rowvals_model_steadystate_scaled(sunindextype *rowvals);
extern void JSparseB_model_steadystate_scaled(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_model_steadystate_scaled(sunindextype *colptrs);
extern void JSparseB_rowvals_model_steadystate_scaled(sunindextype *rowvals);
extern void Jy_model_steadystate_scaled(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_model_steadystate_scaled(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_model_steadystate_scaled(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_model_steadystate_scaled(sunindextype *colptrs, int index);
extern void dJydy_rowvals_model_steadystate_scaled(sunindextype *rowvals, int index);
extern void dwdp_model_steadystate_scaled(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_model_steadystate_scaled(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_model_steadystate_scaled(sunindextype *colptrs);
extern void dwdx_rowvals_model_steadystate_scaled(sunindextype *rowvals);
extern void dxdotdw_model_steadystate_scaled(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_model_steadystate_scaled(sunindextype *colptrs);
extern void dxdotdw_rowvals_model_steadystate_scaled(sunindextype *rowvals);
extern void dxdotdp_model_steadystate_scaled(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_model_steadystate_scaled(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_model_steadystate_scaled(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_model_steadystate_scaled(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_model_steadystate_scaled(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_model_steadystate_scaled(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_model_steadystate_scaled(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_model_steadystate_scaled(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_model_steadystate_scaled(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_model_steadystate_scaled(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_model_steadystate_scaled(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_model_steadystate_scaled(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_model_steadystate_scaled(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_model_steadystate_scaled(realtype *total_cl, const realtype *x_rdata);
...
class Model_model_steadystate_scaled : public amici::Model_ODE {
  public:
    ...
    virtual amici::Model *clone() const override {
        return new Model_model_steadystate_scaled(*this);
    }
    ...
    virtual void fJSparse_colptrs(sunindextype *colptrs) override {
        JSparse_colptrs_model_steadystate_scaled(colptrs);
    }


    virtual void fJSparse_rowvals(sunindextype *rowvals) override {
        JSparse_rowvals_model_steadystate_scaled(rowvals);
    }
    ...
    virtual void fJSparseB_colptrs(sunindextype *colptrs) override {
        JSparseB_colptrs_model_steadystate_scaled(colptrs);
    }


    virtual void fJSparseB_rowvals(sunindextype *rowvals) override {
        JSparseB_rowvals_model_steadystate_scaled(rowvals);
    }
    ...
    virtual void fdJydy_colptrs(sunindextype *colptrs, int index) override {
        dJydy_colptrs_model_steadystate_scaled(colptrs, index);
    }

    virtual void fdJydy_rowvals(sunindextype *rowvals, int index) override {
        dJydy_rowvals_model_steadystate_scaled(rowvals, index);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_model_steadystate_scaled( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_model_steadystate_scaled( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_model_steadystate_scaled( dxdotdw,  t,  x,  p,  k,  h,  w);
    }


    virtual void fdxdotdw_colptrs(sunindextype *colptrs) override {
        dxdotdw_colptrs_model_steadystate_scaled(colptrs);
    }


    virtual void fdxdotdw_rowvals(sunindextype *rowvals) override {
        dxdotdw_rowvals_model_steadystate_scaled(rowvals);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_model_steadystate_scaled( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_model_steadystate_scaled( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_model_steadystate_scaled( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_model_steadystate_scaled( total_cl,  x_rdata);
    }
...
"x3",};
    ...
    virtual std::vector<std::string> getObservableIds() const override {
        return std::vector<std::string>{"observable_x1",
"observable_x2",
"observable_x3",
