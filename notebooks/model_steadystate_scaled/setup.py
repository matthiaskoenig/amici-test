...
model_module = Extension('model_steadystate_scaled._model_steadystate_scaled',
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model_steadystate_scaled',
...
# Install
setup(
    name='model_steadystate_scaled',
    version='0.1.0',
    description='AMICI-generated module for model model_steadystate_scaled',
